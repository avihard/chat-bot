import 'package:chatt/widgets/basicCard.dart';
import 'package:chatt/widgets/carouselSelect.dart';
import 'package:chatt/widgets/simple_message.dart';
...
class _GoogleAssistant extends State<GoogleAssistant> {
  ...
  void Response(query) async {
    ...
    if (response.getMessage() != null && response.getMessage() != "") {
      print(response.getMessage().toString());
